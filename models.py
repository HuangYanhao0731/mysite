...
class ShopDataEight(models.Model):
    item_id = models.CharField(db_column='ITEM_ID', primary_key=True, max_length=255)  # Field name made lowercase.
    data = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'shop_data_eight'


class ShopDataNine(models.Model):
    item_id = models.CharField(db_column='ITEM_ID', primary_key=True, max_length=255)  # Field name made lowercase.
    data = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'shop_data_nine'


class ShopDataSeven(models.Model):
    item_id = models.CharField(db_column='ITEM_ID', primary_key=True, max_length=255)  # Field name made lowercase.
    data = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'shop_data_seven'


class ShopDataSix(models.Model):
    item_id = models.CharField(db_column='ITEM_ID', primary_key=True, max_length=255)  # Field name made lowercase.
    data = models.CharField(max_length=255, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'shop_data_six'
